 ...
 */
public class OWLListComponent extends AbstractPropertyValuesComponent {
    ...
    private ResourceSelectionAction addAction = new ResourceSelectionAction("Add existing value...",
        ...
        public RDFResource pickResource() {
            if (getSubject() instanceof RDFSClass) {
                ...
                return (RDFResource) ProtegeUI.getSelectionDialogFactory().selectClass(OWLListComponent.this,
                                                                                       getOWLModel(), title);
            }
            else if (getSubject() instanceof OWLProperty) {
                String title = "Select a property to add";
                Collection properties = getSelectableResources();
                return ProtegeUI.getSelectionDialogFactory().selectProperty(OWLListComponent.this, getSubject().getOWLModel(),
                                                                            properties, title);
            }
            else {
                OWLModel owlModel = getOWLModel();
                ...
                RDFResource result = ProtegeUI.getSelectionDialogFactory().selectResourceByType(OWLListComponent.this, owlModel, classes);
    ...
    public OWLListComponent(RDFProperty predicate) {
        super(predicate);
