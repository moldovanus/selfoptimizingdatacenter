...
public class RandomWorkLoadGenerator {
     ...
     * @return
     */
    public static WorkLoadLoader generateRandomWorkLoad(int workLoadSequenceNo, int maxSequenceLength, int maxSequenceDelayInMillis, ProtegeFactory protegeFactory, OntModel model) {
